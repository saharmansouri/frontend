...
export default function Sessions() {
  ...
  const [sessionFree, setSessionFree] = useState("-1");
      ...
      <div class="container-fluid" id="home-content">
        <div class="container">
          ...
          <form class="form">
            ...
            <div class="col-6">
              <div class="price input">
                <label class="input-title">هزینه دوره</label>
                <select className="select" onChange={event=>setSessionFree(event.target.value)} >
          ...
          <tbody>
            {sessions.map((session, index) => (
              <tr key={session._id}>
                ...
                <td>{session.title}</td>
                <td>{session.time}</td>
                <td>{session.free === 0 ? "free" : "premium"}</td>
